...
<body>
    ...
    <section id="picture" class="position-relative">
        <div class="position-relative w-100 d-none d-xl-flex" style="height: 636px;">
            <img src="{{ asset('johancindy.jpg') }}" alt="Novita Family picture"
        ...
        <div class="position-relative w-100 d-flex d-xl-none" style="height: 636px;">
            <img src="{{ asset('johancindy_mobile.jpg') }}" alt="Novita Family picture"
                class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-n1">
        </div>
    </section>
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            ...
                            <img src="{{ asset('picture_121.jpg') }}" alt="picture 121" class="w-100 mb-1 preview-image"
                                id="picture_121">
                            <img src="{{ asset('picture_122.jpg') }}" alt="picture 122" class="w-100 mb-1 preview-image"
                                id="picture_122">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_123.jpg') }}" alt="picture 123" class="w-100 mb-1 preview-image"
                                id="picture_123">
                            <img src="{{ asset('picture_124.jpg') }}" alt="picture 124" class="w-100 mb-1 preview-image"
                                id="picture_124">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_125.jpg') }}" alt="picture 125" class="w-100 mb-1 preview-image"
                                id="picture_125">
                            <img src="{{ asset('picture_126.jpg') }}" alt="picture 126" class="w-100 mb-1 preview-image"
                                id="picture_126">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_127.jpg') }}" alt="picture 127" class="w-100 mb-1 preview-image"
                                id="picture_127">
                        ...
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_129.jpg') }}" alt="picture 129" class="w-100 mb-1 preview-image"
                                id="picture_129">
                            <img src="{{ asset('picture_130.jpg') }}" alt="picture 130" class="w-100 mb-1 preview-image"
                                id="picture_130">
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3 hidden-gallery d-none">
                        ...
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_133.jpg') }}" alt="picture 133" class="w-100 mb-1 preview-image"
                                id="picture_133">
                            <img src="{{ asset('picture_134.jpg') }}" alt="picture 134" class="w-100 mb-1 preview-image"
                                id="picture_134">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
