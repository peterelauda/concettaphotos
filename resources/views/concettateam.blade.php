...
<body>
    ...
    <section id="profile">
        <div class="container-fluid" style="margin-top: 140.21px;">
            <div class="px-4 pt-5 text-center">
                <h1 class="display-3 mt-3 aesthetic-text-1">Concetta Team</h1>
                <div class="col-10 col-md-8 col-lg-6 mx-auto pt-1 mb-4 custom-border"></div>
            </div>
        </div>

        <div class="container col-xxl-8 px-5 pt-sm-0">

            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">

                <div class="col-12 col-sm-10 col-md-8 col-lg-6 mx-auto">
                    <img src="photo_profile.jpg" class="d-block mx-auto img-fluid zoom-on-scroll rounded-4"
                        alt="Photographer Profile Photo - Michael" width="1000" height="1000" loading="lazy">
                </div>

                <div class="col-lg-6">
                    <h1 class="display-7 lh-1 mb-3 text-end aesthetic-text-2">Michael</h1>
                    <h1 class="display-3 mb-2 text-end custom-text lang-content lang-en">Founder</h1>
                    <h1 class="display-3 mb-2 text-end custom-text lang-content lang-id d-none">Pendiri</h1>
                    <h1 class="display-7 mb-3 text-end custom-text lang-content lang-en">& Photographer</h1>
                    <h1 class="display-7 mb-3 text-end custom-text lang-content lang-id d-none">& Fotografer</h1>
                    <p class="lead custom-text-0 lang-content lang-en text-justify-right">
                    ...
                    <p class="lead custom-text-0 lang-content lang-id d-none text-justify-right">
            ...
            <div class="container py-5">
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-12 col-sm-10 col-md-8 col-lg-6 mt-0 mx-auto">
                        <img src="photo_profile1.jpg" class="d-block mx-auto img-fluid zoom-on-scroll rounded-4"
                            alt="Concetta Co-founder Profile - Atika" width="1000" height="1000" loading="lazy">
                    </div>

                    <div class="col-lg-6">
                        <h1 class="display-7 lh-1 mb-3 aesthetic-text-2">Atika</h1>
                        <h1 class="display-3 mb-2 custom-text lang-content lang-en">Co-founder</h1>
                        <h1 class="display-3 mb-2 custom-text lang-content lang-id d-none">Rekan</h1>
                        <h1 class="display-5 mb-2 custom-text">& Admin</h1>
                        <p class="lead custom-text-0 lang-content lang-en text-justify-left">
                        ...
                        <p class="lead custom-text-0 lang-content lang-id d-none text-justify-left">
                        ...
                        <div class="d-flex flex-column flex-xl-row gap-3 align-items-stretch w-100">
                            <a href="http://wa.me/6287762982309" target="_blank" rel="noopener noreferrer"
                            ...
                            <div class="dropdown w-100 w-md-75 w-lg-50 w-xl-25">
                                <button
                                    class="btn btn-outline-primary btn-lg px-4 dropdown-toggle custom-dropdown w-100 w-md-75 w-lg-50 w-xl-25 lang-content lang-en responsive-text"
                                    type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
                                    aria-expanded="false"><span class="responsive-text">More</span>
                                </button>
                                <button
                                    class="btn btn-outline-primary btn-lg px-4 dropdown-toggle custom-dropdown w-100 w-md-75 w-lg-50 w-xl-25 lang-content lang-id d-none responsive-text"
                                    type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
                                    aria-expanded="false"><span class="responsive-text">Selengkapnya</span>
                                </button>
        ...
        <main class="container">
            <div
                ...
                <div class="col-lg-6 px-0">
                    ...
                    <h5 class="display-10 custom-text-0 lang-content lang-en">Are we feeling familiar with each other now?
                    </h5>
