                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            ...
                            <img src="{{ asset('picture_161.jpg') }}" alt="picture 161" class="w-100 mb-1 preview-image"
                                id="picture_161">
                            <img src="{{ asset('picture_162.jpg') }}" alt="picture 162" class="w-100 mb-1 preview-image"
                                id="picture_162">
                            <img src="{{ asset('picture_163.jpg') }}" alt="picture 163" class="w-100 mb-1 preview-image"
                                id="picture_163">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_164.jpg') }}" alt="picture 164" class="w-100 mb-1 preview-image"
                                id="picture_164">
                            <img src="{{ asset('picture_165.jpg') }}" alt="picture 165" class="w-100 mb-1 preview-image"
                                id="picture_165">
                            <img src="{{ asset('picture_166.jpg') }}" alt="picture 166" class="w-100 mb-1 preview-image"
                                id="picture_166">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_167.jpg') }}" alt="picture 167" class="w-100 mb-1 preview-image"
                                id="picture_167">
                            <img src="{{ asset('picture_168.jpg') }}" alt="picture 168" class="w-100 mb-1 preview-image"
                                id="picture_168">
                            <img src="{{ asset('picture_169.jpg') }}" alt="picture 169" class="w-100 mb-1 preview-image"
                                id="picture_169">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_170.jpg') }}" alt="picture 170" class="w-100 mb-1 preview-image"
                                id="picture_170">
                            <img src="{{ asset('picture_171.jpg') }}" alt="picture 171" class="w-100 mb-1 preview-image"
                                id="picture_171">
                            <img src="{{ asset('picture_172.jpg') }}" alt="picture 172" class="w-100 mb-1 preview-image"
                                id="picture_172">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_173.jpg') }}" alt="picture 173" class="w-100 mb-1 preview-image"
                                id="picture_173">
                            <img src="{{ asset('picture_174.jpg') }}" alt="picture 174" class="w-100 mb-1 preview-image"
                                id="picture_174">
                            <img src="{{ asset('picture_175.jpg') }}" alt="picture 175" class="w-100 mb-1 preview-image"
                                id="picture_175">
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3 hidden-gallery d-none">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_176.jpg') }}" alt="picture 176" class="w-100 mb-1 preview-image"
                                id="picture_176">
                            <img src="{{ asset('picture_177.jpg') }}" alt="picture 177" class="w-100 mb-1 preview-image"
                                id="picture_177">
                            <img src="{{ asset('picture_178.jpg') }}" alt="picture 178" class="w-100 mb-1 preview-image"
                                id="picture_178">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_179.jpg') }}" alt="picture 179" class="w-100 mb-1 preview-image"
                                id="picture_179">
                            <img src="{{ asset('picture_180.jpg') }}" alt="picture 180" class="w-100 mb-1 preview-image"
                                id="picture_180">
                            <img src="{{ asset('picture_181.jpg') }}" alt="picture 181" class="w-100 mb-1 preview-image"
                                id="picture_181">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_182.jpg') }}" alt="picture 182" class="w-100 mb-1 preview-image"
                                id="picture_182">
                            <img src="{{ asset('picture_183.jpg') }}" alt="picture 183" class="w-100 mb-1 preview-image"
                                id="picture_183">
                            <img src="{{ asset('picture_184.jpg') }}" alt="picture 184" class="w-100 mb-1 preview-image"
                                id="picture_184">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_185.jpg') }}" alt="picture 185" class="w-100 mb-1 preview-image"
                                id="picture_185">
                            <img src="{{ asset('picture_186.jpg') }}" alt="picture 186" class="w-100 mb-1 preview-image"
                                id="picture_186">
                            <img src="{{ asset('picture_187.jpg') }}" alt="picture 187" class="w-100 mb-1 preview-image"
                                id="picture_187">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_188.jpg') }}" alt="picture 188" class="w-100 mb-1 preview-image"
                                id="picture_188">
                            <img src="{{ asset('picture_189.jpg') }}" alt="picture 189" class="w-100 mb-1 preview-image"
                                id="picture_189">
                            <img src="{{ asset('picture_190.jpg') }}" alt="picture 190" class="w-100 mb-1 preview-image"
                                id="picture_190">
                        </div>
                    </div>
