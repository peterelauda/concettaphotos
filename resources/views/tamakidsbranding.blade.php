...
<head>
    ...
    <title>Concetta Photos - Tama Kids Branding</title>
    ...
    <meta property="og:image" content="{{ url('tamakidsbranding_mobile.jpg') }}" />
    ...
    <meta name="twitter:image" content="{{ url('tamakidsbranding_mobile.jpg') }}" />
...
<body>
    ...
    <section id="picture" class="position-relative">
        <div class="position-relative w-100 d-none d-lg-flex" style="height: 636px;">
            <img src="{{ asset('tamakidsbranding.jpg') }}" alt="Novita Family picture"
        ...
        <div class="position-relative w-100 d-flex d-lg-none" style="height: 636px;">
            <img src="{{ asset('tamakidsbranding_mobile.jpg') }}" alt="Novita Family picture"
                class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-n1">
        </div>
    </section>
    ...
    <section id="novitafamily">
        <div class="container-fluid py-5">
            <div class="px-4 py-3 text-center">
                <h1 class="display-7 aesthetic-text-1 mb-2 lang-content lang-en">Tama Kids Branding Album</h1>
                <h1 class="display-7 aesthetic-text-1 mb-2 lang-content lang-id d-none">Album Branding Tama Kids
                </h1>
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            ...
                            <img src="{{ asset('picture_403.jpg') }}" alt="picture 403" class="w-100 mb-1 preview-image"
                                id="picture_403">
                            <img src="{{ asset('picture_404.jpg') }}" alt="picture 404" class="w-100 mb-1 preview-image"
                                id="picture_404">
                            <img src="{{ asset('picture_405.jpg') }}" alt="picture 405" class="w-100 mb-1 preview-image"
                                id="picture_405">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_406.jpg') }}" alt="picture 406" class="w-100 mb-1 preview-image"
                                id="picture_406">
                            <img src="{{ asset('picture_407.jpg') }}" alt="picture 407" class="w-100 mb-1 preview-image"
                                id="picture_407">
                            <img src="{{ asset('picture_408.jpg') }}" alt="picture 408" class="w-100 mb-1 preview-image"
                                id="picture_408">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_409.jpg') }}" alt="picture 409" class="w-100 mb-1 preview-image"
                                id="picture_409">
                            <img src="{{ asset('picture_410.jpg') }}" alt="picture 410" class="w-100 mb-1 preview-image"
                                id="picture_410">
                            <img src="{{ asset('picture_411.jpg') }}" alt="picture 411" class="w-100 mb-1 preview-image"
                                id="picture_411">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_412.jpg') }}" alt="picture 412" class="w-100 mb-1 preview-image"
                                id="picture_412">
                            <img src="{{ asset('picture_413.jpg') }}" alt="picture 413" class="w-100 mb-1 preview-image"
                                id="picture_413">
                            <img src="{{ asset('picture_414.jpg') }}" alt="picture 414" class="w-100 mb-1 preview-image"
                                id="picture_414">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_415.jpg') }}" alt="picture 415" class="w-100 mb-1 preview-image"
                                id="picture_415">
                            <img src="{{ asset('picture_416.jpg') }}" alt="picture 416" class="w-100 mb-1 preview-image"
                                id="picture_416">
                            <img src="{{ asset('picture_417.jpg') }}" alt="picture 417" class="w-100 mb-1 preview-image"
                                id="picture_417">
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3 hidden-gallery d-none">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_418.jpg') }}" alt="picture 418" class="w-100 mb-1 preview-image"
                                id="picture_418">
                            <img src="{{ asset('picture_419.jpg') }}" alt="picture 419" class="w-100 mb-1 preview-image"
                                id="picture_419">
                            <img src="{{ asset('picture_420.jpg') }}" alt="picture 420" class="w-100 mb-1 preview-image"
                                id="picture_420">
                            <img src="{{ asset('picture_421.jpg') }}" alt="picture 421" class="w-100 mb-1 preview-image"
                                id="picture_421">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">

                            <img src="{{ asset('picture_422.jpg') }}" alt="picture 422" class="w-100 mb-1 preview-image"
                                id="picture_422">
                            <img src="{{ asset('picture_423.jpg') }}" alt="picture 423" class="w-100 mb-1 preview-image"
                                id="picture_423">
                            <img src="{{ asset('picture_424.jpg') }}" alt="picture 424" class="w-100 mb-1 preview-image"
                                id="picture_424">
                            <img src="{{ asset('picture_425.jpg') }}" alt="picture 425" class="w-100 mb-1 preview-image"
                                id="picture_425">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">

                            <img src="{{ asset('picture_426.jpg') }}" alt="picture 426" class="w-100 mb-1 preview-image"
                                id="picture_426">
                            <img src="{{ asset('picture_427.jpg') }}" alt="picture 427" class="w-100 mb-1 preview-image"
                                id="picture_427">
                            <img src="{{ asset('picture_428.jpg') }}" alt="picture 428" class="w-100 mb-1 preview-image"
                                id="picture_428">
                            <img src="{{ asset('picture_429.jpg') }}" alt="picture 429" class="w-100 mb-1 preview-image"
                                id="picture_429">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_430.jpg') }}" alt="picture 430" class="w-100 mb-1 preview-image"
                                id="picture_430">
                            <img src="{{ asset('picture_431.jpg') }}" alt="picture 431" class="w-100 mb-1 preview-image"
                                id="picture_431">
                            <img src="{{ asset('picture_432.jpg') }}" alt="picture 432" class="w-100 mb-1 preview-image"
                                id="picture_432">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">

                            <img src="{{ asset('picture_433.jpg') }}" alt="picture 433" class="w-100 mb-1 preview-image"
                                id="picture_433">
                            <img src="{{ asset('picture_434.jpg') }}" alt="picture 434" class="w-100 mb-1 preview-image"
                                id="picture_434">
                            <img src="{{ asset('picture_435.jpg') }}" alt="picture 435" class="w-100 mb-1 preview-image"
                                id="picture_435">
                        </div>
                    </div>
