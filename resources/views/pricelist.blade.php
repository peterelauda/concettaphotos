...
<body>
    ...
    <section id="picture" class="position-relative">
        <div class="position-relative w-100" style="height: 636px;">
            <img src="{{ asset('price.jpg') }}" alt="about picture"
        ...
        <div class="container py-5 px-5">
            <main>
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-4 text-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color" style="height: 336.98px;">
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color" style="height: 336.98px;">
                            ...
                            <div
                                class="card-body d-flex justify-content-center align-items-center flex-column text-center">
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color-1" style="height: 336.98px;">
                            <div class="card-header py-3">
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-4 text-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color" style="height: 360.97px;">
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal custom-text-4">Express</h4>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-en">2 Hours</h6>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-id d-none">2 Jam</h6>
                            ...
                            <div class="card-body d-flex justify-content-center align-items-center flex-column text-center"
                                ...
                                <h1 class="card-title pricing-card-title custom-text-0 lang-content lang-id d-none">RP
                                    2,959K</h1>
                                <ul class="list-unstyled mt-3 mb-3 custom-text-0">
                                    <li class="lang-content lang-en">1 location, 100 edited + 20 fine edited</li>
                                    <li class="lang-content lang-id d-none">1 lokasi, 100 edited + 20 fine edited</li>
                        ...
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color" style="height: 360.97px;">
                            ...
                            <div class="card-body d-flex justify-content-center align-items-center flex-column text-center"
                                ...
                                <h1 class="card-title pricing-card-title custom-text-0 lang-content lang-id d-none">RP
                                    5,099K</h1>
                                <ul class="list-unstyled mt-3 mb-3 custom-text-0">
                                    <li class="lang-content lang-en">2 locations, 160 edited + 30 fine edited, 2-3
                                        minutes</li>
                                    <li class="lang-content lang-id d-none">2 lokasi, 160 edited + 30 fine edited, 2-3
                                        menit</li>
                                    <li class="lang-content lang-en">Cinematic video with drone, 1 minute highlight
                                        video</li>
                                    <li class="lang-content lang-id d-none">Video sinematik dengan drone, 1 menit video
                                        sorotan</li>
                                    <li>Via Google Drive</li>
                                </ul>
                                <a href="/faqs#inquiry">
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color-1" style="height: 360.97px;">
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal custom-text-4">Full Day</h4>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-en">12 Hours</h6>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-id d-none">12 Jam</h6>
                            ...
                            <div class="card-body d-flex justify-content-center align-items-center flex-column text-center"
                                ...
                                <h1 class="card-title pricing-card-title custom-text-0 lang-content lang-id d-none">RP
                                    8,499K</h1>
                                <ul class="list-unstyled mt-3 mb-3 custom-text-0">
                                    <li class="lang-content lang-en">3 locations, 200 edited + 50 fine edited</li>
                                    <li class="lang-content lang-id d-none">3 lokasi, 200 edited + 50 fine edited</li>
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-4 text-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color" style="height: 400px;">
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal custom-text-4">Express</h4>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-en">2 Hours</h6>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-id d-none">2 Jam</h6>
                        ...
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color" style="height: 400px;">
                            ...
                            <div
                                ...
                                <h1 class="card-title pricing-card-title custom-text-0 lang-content lang-id d-none">RP
                                    6,199K</h1>
                                <ul class="list-unstyled mt-3 mb-4 custom-text-0">
                                    <li class="lang-content lang-en">2 locations, 160 edited + 30 fine edited</li>
                                    <li class="lang-content lang-id d-none">2 lokasi, 160 edited + 30 fine edited</li>
                                    <li class="lang-content lang-en">2-3 minutes cinematic video with drone, 1 minute
                                        highlight video</li>
                                    <li class="lang-content lang-id d-none">2-3 menit video sinematik dengan drone, 1
                                        menit video sorotan</li>
                                    <li>Via Google Drive</li>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color-1" style="height: 400px;">
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal custom-text-4">Full Day</h4>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-en">12 Hours</h6>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-id d-none">12 Jam</h6>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color" style="height: 400px;">
                            ...
                            <div
                                ...
                                <ul class="list-unstyled mt-3 mb-4 custom-text-0">
                                    <li class="lang-content lang-en">2 locations, 160 edited + 30 fine edited</li>
                                    <li class="lang-content lang-id d-none">2 lokasi, 160 foto diedit + 30 editing halus
                                    </li>
                                    <li class="lang-content lang-en">2-3 minutes cinematic video with drone, 1 highlight
                                        video</li>
                                    <li class="lang-content lang-id d-none">2-3 menit video sinematik dengan drone, 1
                                        video sorotan</li>
                                    <li>Via Google Drive</li>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color-1" style="height: 400px;">
                            ...
                            <div
                                ...
                                <ul class="list-unstyled mt-3 mb-4 custom-text-0">
                                    <li class="lang-content lang-en">3 locations, 200 edited + 50 fine edited</li>
                                    <li class="lang-content lang-id d-none">3 lokasi, 200 foto diedit + 50 editing halus
                                    </li>
                                    <li class="lang-content lang-en">2-3 minutes cinematic video with drone, 1 highlight
                                        video</li>
                                    <li class="lang-content lang-id d-none">2-3 menit video sinematik dengan drone, 1
                ...
                <div class="row row-cols-1 row-cols-md-3 mb-4 text-center">
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color" style="height: 420px;">
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal custom-text-4">Express</h4>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-en">2 Hours</h6>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-id d-none">2 Jam</h6>
                            ...
                            <div class="card-body d-flex justify-content-center align-items-center flex-column text-center"
                                ...
                                <ul class="list-unstyled mt-3 mb-3 custom-text-0">
                                    <li class="lang-content lang-en">1 location, 100 edited + 20 fine edited</li>
                                    <li class="lang-content lang-id d-none">1 lokasi, 100 foto diedit + 20 editing halus
                                    </li>
                                    <li class="lang-content lang-en">2-3 minutes cinematic video</li>
                                    <li class="lang-content lang-id d-none">2-3 menit video sinematik</li>
                                    <li>Via Google Drive</li>
                        ...
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color" style="height: 420px;">
                            ...
                            <div
                                ...
                                <ul class="list-unstyled mt-3 mb-4 custom-text-0">
                                    ...
                                    <li class="lang-content lang-en">Makeup & hair with following, include retouch & 2
                                        hairstyles</li>
                                    <li class="lang-content lang-id d-none">Rias & rambut dengan pendampingan, termasuk
                                        retouch & 2 gaya rambut</li>
                                    <li class="lang-content lang-en">1 Gown</li>
                                    <li class="lang-content lang-id d-none">1 Gaun</li>
                                </ul>
                    ...
                    <div class="col">
                        <div class="card mb-4 rounded-3 shadow-sm card-custom-color-1" style="height: 420px;">
                            <div class="card-header py-3">
                                <h4 class="my-0 fw-normal custom-text-4">Full Day</h4>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-en">12 Hours</h6>
                                <h6 class="my-0 fw-normal custom-text-4 lang-content lang-id d-none">12 Jam</h6>
