...
<head>
    ...
    <title>Concetta Photos - Amelita Family</title>
    ...
    <meta property="og:image" content="{{ url('amelitafamily_mobile.jpg') }}" />
    ...
    <meta name="twitter:image" content="{{ url('amelitafamily_mobile.jpg') }}" />
...
<body>
    ...
    <section id="picture" class="position-relative">
        <div class="position-relative w-100 d-none d-lg-flex" style="height: 636px;">
            <img src="{{ asset('amelitafamily.jpg') }}" alt="Novita Family picture"
        ...
        <div class="position-relative w-100 d-flex d-lg-none" style="height: 636px;">
            <img src="{{ asset('amelitafamily_mobile.jpg') }}" alt="Novita Family picture"
                class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-n1">
        </div>
    </section>

    <section id="amelitafamily">
        <div class="container-fluid py-5">
            <div class="px-4 py-3 text-center">
                <h1 class="display-5 aesthetic-text-1 mb-2 lang-content lang-en">Amelita's Family Album</h1>
                <h1 class="display-5 aesthetic-text-1 mb-2 lang-content lang-id d-none">Album Keluarga Amelita</h1>
                <div class="col-12 col-sm-12 col-md-9 col-lg-6 col-xl-3 mx-auto custom-border-divider mb-2"></div>
                <h1 class="display-7 aesthetic-text-3 mb-5 lang-content lang-en">At Apurva Kempinski</h1>
                <h1 class="display-7 aesthetic-text-3 mb-5 lang-content lang-id d-none">di Apurva Kempinski</h1>
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            ...
                            <img src="{{ asset('picture_41.jpg') }}" alt="picture 41" class="w-100 mb-1 preview-image"
                                id="picture_41">
                            <img src="{{ asset('picture_42.jpg') }}" alt="picture 42" class="w-100 mb-1 preview-image"
                                id="picture_42">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_43.jpg') }}" alt="picture 43" class="w-100 mb-1 preview-image"
                                id="picture_43">
                            <img src="{{ asset('picture_44.jpg') }}" alt="picture 44" class="w-100 mb-1 preview-image"
                                id="picture_44">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_45.jpg') }}" alt="picture 45" class="w-100 mb-1 preview-image"
                                id="picture_45">
                            <img src="{{ asset('picture_46.jpg') }}" alt="picture 46" class="w-100 mb-1 preview-image"
                                id="picture_46">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_47.jpg') }}" alt="picture 47" class="w-100 mb-1 preview-image"
                                id="picture_47">
                            <img src="{{ asset('picture_48.jpg') }}" alt="picture 48" class="w-100 mb-1 preview-image"
                                id="picture_48">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_49.jpg') }}" alt="picture 49" class="w-100 mb-1 preview-image"
                                id="picture_49">
                            <img src="{{ asset('picture_50.jpg') }}" alt="picture 50" class="w-100 mb-1 preview-image"
                                id="picture_50">
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3 hidden-gallery d-none">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_51.jpg') }}" alt="picture 51" class="w-100 mb-1 preview-image"
                                id="picture_51">
                            <img src="{{ asset('picture_52.jpg') }}" alt="picture 52" class="w-100 mb-1 preview-image"
                                id="picture_52">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_53.jpg') }}" alt="picture 53" class="w-100 mb-1 preview-image"
                                id="picture_53">
                            <img src="{{ asset('picture_54.jpg') }}" alt="picture 54" class="w-100 mb-1 preview-image"
                                id="picture_54">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_55.jpg') }}" alt="picture 55" class="w-100 mb-1 preview-image"
                                id="picture_55">
                            <img src="{{ asset('picture_56.jpg') }}" alt="picture 56" class="w-100 mb-1 preview-image"
                                id="picture_56">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_57.jpg') }}" alt="picture 57" class="w-100 mb-1 preview-image"
                                id="picture_57">
                            <img src="{{ asset('picture_58.jpg') }}" alt="picture 58" class="w-100 mb-1 preview-image"
                                id="picture_58">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_59.jpg') }}" alt="picture 59" class="w-100 mb-1 preview-image"
                                id="picture_59">
                            <img src="{{ asset('picture_60.jpg') }}" alt="picture 60" class="w-100 mb-1 preview-image"
                                id="picture_60">
                        </div>
                    </div>
