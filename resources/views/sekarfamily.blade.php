...
<head>
    ...
    <title>Concetta Photos - Sekar Family</title>
    ...
    <meta property="og:image" content="{{ url('sekarfamily_mobile.jpg') }}" />
    ...
    <meta name="twitter:image" content="{{ url('sekarfamily_mobile.jpg') }}" />
...
<body>
    ...
    <section id="picture" class="position-relative">
        <div class="position-relative w-100 d-none d-lg-flex" style="height: 636px;">
            <img src="{{ asset('sekarfamily.jpg') }}" alt="Sekar Family picture"
        ...
        <div class="position-relative w-100 d-flex d-lg-none" style="height: 636px;">
            <img src="{{ asset('sekarfamily_mobile.jpg') }}" alt="Sekar Family picture"
                class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-n1">
        </div>
    </section>

    <section id="sekarfamily">
        <div class="container-fluid py-5">
            <div class="px-4 py-3 text-center">
                <h1 class="display-5 aesthetic-text-1 mb-2 lang-content lang-en">Sekar's Family Album</h1>
                <h1 class="display-5 aesthetic-text-1 mb-2 lang-content lang-id d-none">Album Keluarga Sekar</h1>
                <div class="col-12 col-sm-12 col-md-9 col-lg-6 col-xl-3 mx-auto custom-border-divider mb-2"></div>
                <h1 class="display-7 aesthetic-text-3 mb-5 lang-content lang-en">At Padma Legian</h1>
                <h1 class="display-7 aesthetic-text-3 mb-5 lang-content lang-id d-none">di Padma Legian</h1>
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            ...
                            <img src="{{ asset('picture_81.jpg') }}" alt="picture 81" class="w-100 mb-1 preview-image"
                                id="picture_81">
                            <img src="{{ asset('picture_82.jpg') }}" alt="picture 82" class="w-100 mb-1 preview-image"
                                id="picture_82">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_83.jpg') }}" alt="picture 83" class="w-100 mb-1 preview-image"
                                id="picture_83">
                            <img src="{{ asset('picture_84.jpg') }}" alt="picture 84" class="w-100 mb-1 preview-image"
                                id="picture_84">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_85.jpg') }}" alt="picture 85" class="w-100 mb-1 preview-image"
                                id="picture_85">
                            <img src="{{ asset('picture_86.jpg') }}" alt="picture 86" class="w-100 mb-1 preview-image"
                                id="picture_86">
                            <img src="{{ asset('picture_87.jpg') }}" alt="picture 87" class="w-100 mb-1 preview-image"
                                id="picture_87">
                        ...
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            ...
                            <img src="{{ asset('picture_88.jpg') }}" alt="picture 88" class="w-100 mb-1 preview-image"
                                id="picture_88">
                            <img src="{{ asset('picture_89.jpg') }}" alt="picture 89" class="w-100 mb-1 preview-image"
                                id="picture_89">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_90.jpg') }}" alt="picture 90" class="w-100 mb-1 preview-image"
                                id="picture_90">
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3 hidden-gallery d-none">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_91.jpg') }}" alt="picture 91" class="w-100 mb-1 preview-image"
                                id="picture_91">
                            <img src="{{ asset('picture_92.jpg') }}" alt="picture 92" class="w-100 mb-1 preview-image"
                                id="picture_92">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_93.jpg') }}" alt="picture 93" class="w-100 mb-1 preview-image"
                                id="picture_93">
                            <img src="{{ asset('picture_94.jpg') }}" alt="picture 94" class="w-100 mb-1 preview-image"
                                id="picture_94">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_95.jpg') }}" alt="picture 95" class="w-100 mb-1 preview-image"
                                id="picture_95">
                            <img src="{{ asset('picture_96.jpg') }}" alt="picture 96" class="w-100 mb-1 preview-image"
                                id="picture_96">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_97.jpg') }}" alt="picture 97" class="w-100 mb-1 preview-image"
                                id="picture_97">
                            <img src="{{ asset('picture_98.jpg') }}" alt="picture 98" class="w-100 mb-1 preview-image"
                                id="picture_98">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_99.jpg') }}" alt="picture 99" class="w-100 mb-1 preview-image"
                                id="picture_99">
                            <img src="{{ asset('picture_100.jpg') }}" alt="picture 100" class="w-100 mb-1 preview-image"
                                id="picture_100">
                        </div>
                    </div>
