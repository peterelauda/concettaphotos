    ...
    <section id="sekarfamily">
        <div class="container-fluid py-5">
            <div class="px-4 py-3 text-center">
                <h1 class="display-5 custom-text-3 mb-2 lang-content lang-en">Sekar's Family Album</h1>
                <h1 class="display-5 custom-text-3 mb-2 lang-content lang-id d-none">Album Keluarga Sekar</h1>
                <div class="col-12 col-sm-12 col-md-9 col-lg-6 col-xl-3 mx-auto custom-border-divider mb-2"></div>
                <h1 class="display-7 custom-text-0 mb-5 lang-content lang-en">At Padma Legian</h1>
                <h1 class="display-7 custom-text-0 mb-5 lang-content lang-id d-none">di Padma Legian</h1>
