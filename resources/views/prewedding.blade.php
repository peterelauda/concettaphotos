...
<body>
    ...
    <section id="picture" class="position-relative">
        <div class="position-relative w-100 d-none d-xl-flex" style="height: 636px;">
            <img src="{{ asset('prewedding.jpg') }}" alt="Holiday and Family Picture"
        ...
        <div class="position-relative w-100 d-flex d-xl-none" style="height: 636px;">
            <img src="{{ asset('prewedding_mobile.jpg') }}" alt="Holiday and Family Picture"
                class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-n1">
        </div>
    </section>
                                ...
                                <a href="/andiangginiprewedding" class="image-hover-wrapper text-decoration-none">
                                    <div class="image-hover-container">
                                        ...
                                        <div class="image-hover-overlay p-4">
                                            ...
                                            <h5 class="custom-text-2 lang-content lang-id d-none">Lihat lebih banyak
                                                foto-foto Prewedding Andi & Anggini
                                            </h5>
                                        </div>
                                    </div>
                                </a>
                        ...
                        <div class="col">
                            <div class="card rounded-4 h-100 shadow-sm">
                                    ...
                                    <div class="image-hover-container">
                                        ...
                                        <div class="image-hover-overlay p-4">
                                            ...
                                            <h5 class="custom-text-2 lang-content lang-en">See more Johan & Cindy
                                                Prewedding Photos</h5>
                                            <h5 class="custom-text-2 lang-content lang-id d-none">Lihat lebih banyak
                                                foto-foto Prewedding Johan & Cindy
                                            </h5>
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body d-flex flex-column justify-content-between">
                                    ...
                                    <p class="card-text custom-text-0 lang-content lang-id d-none">
                                        Di antara angin senja dan tatap penuh makna, Johan & Cindy merangkai cinta
                                        menuju hari bahagia.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group"> <a href="/johancindyprewedding"
                                                class="btn btn-sm btn-primary rounded-3 lang-content lang-en">View
                                                More</a>
                                            <a href="/johancindyprewedding"
                                                class="btn btn-sm btn-primary rounded-3 lang-content lang-id d-none">Lihat
                                                Lebih
                                                Banyak</a>
                                        </div>
                        ...
                        <div class="col">
                            <div class="card rounded-4 h-100 shadow-sm">
                                    ...
                                    <div class="image-hover-container">
                                        ...
                                        <div class="image-hover-overlay p-4">
                                            ...
                                            <h5 class="custom-text-2 lang-content lang-en">See more Metta & Iskandar
                                                ...
                                                Photos</h5>
                                            <h5 class="custom-text-2 lang-content lang-id d-none">Lihat lebih banyak
                                                foto-foto Prewedding Metta & Iskandar
                                            </h5>
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body d-flex flex-column justify-content-between">
                                    ...
                                    <p class="card-text custom-text-0 lang-content lang-id d-none">
                                        Langkah demi langkah, Metta & Iskandar menapaki kisah cinta yang sebentar lagi
                                        menjadi abadi.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group"> <a href="/mettaiskandarprewedding"
                                                class="btn btn-sm btn-primary rounded-3 lang-content lang-en">View
                                                More</a>
                                            <a href="/mettaiskandarprewedding"
                                                class="btn btn-sm btn-primary rounded-3 lang-content lang-id d-none">Lihat
                                                Lebih
                                                Banyak</a>
                                        </div>
