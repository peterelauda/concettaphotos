...
<head>
    ...
    <title>Concetta Photos - Andi & Anggini Prewedding</title>
    ...
    <meta property="og:image" content="{{ url('andianggini_mobile.jpg') }}" />
    ...
    <meta name="twitter:image" content="{{ url('andianggini_mobile.jpg') }}" />
...
<body>
    ...
    <section id="picture" class="position-relative">
        <div class="position-relative w-100 d-none d-xl-flex" style="height: 636px;">
            <img src="{{ asset('andianggini.jpg') }}" alt="Novita Family picture"
        ...
        <div class="position-relative w-100 d-flex d-xl-none" style="height: 636px;">
            <img src="{{ asset('andianggini_mobile.jpg') }}" alt="Novita Family picture"
                class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-n1">
        </div>
    </section>
    ...
    <section id="novitafamily">
        <div class="container-fluid py-5">
            <div class="px-4 py-3 text-center">
                <h1 class="display-7 aesthetic-text-1 mb-2 lang-content lang-en">Andi & Anggini Prewedding Album</h1>
                <h1 class="display-7 aesthetic-text-1 mb-2 lang-content lang-id d-none">Album Prewedding Andi & Anggini
                </h1>
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            ...
                            <img src="{{ asset('picture_101.jpg') }}" alt="picture 101" class="w-100 mb-1 preview-image"
                                id="picture_101">
                            <img src="{{ asset('picture_102.jpg') }}" alt="picture 102" class="w-100 mb-1 preview-image"
                                id="picture_102">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_103.jpg') }}" alt="picture 103" class="w-100 mb-1 preview-image"
                                id="picture_103">
                            <img src="{{ asset('picture_104.jpg') }}" alt="picture 104" class="w-100 mb-1 preview-image"
                                id="picture_104">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_105.jpg') }}" alt="picture 105" class="w-100 mb-1 preview-image"
                                id="picture_105">
                            <img src="{{ asset('picture_106.jpg') }}" alt="picture 106" class="w-100 mb-1 preview-image"
                                id="picture_106">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_107.jpg') }}" alt="picture 107" class="w-100 mb-1 preview-image"
                                id="picture_107">
                            <img src="{{ asset('picture_108.jpg') }}" alt="picture 108" class="w-100 mb-1 preview-image"
                                id="picture_108">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_109.jpg') }}" alt="picture 109" class="w-100 mb-1 preview-image"
                                id="picture_109">
                            <img src="{{ asset('picture_110.jpg') }}" alt="picture 110" class="w-100 mb-1 preview-image"
                                id="picture_110">
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3 hidden-gallery d-none">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_111.jpg') }}" alt="picture 111" class="w-100 mb-1 preview-image"
                                id="picture_111">
                            <img src="{{ asset('picture_112.jpg') }}" alt="picture 112" class="w-100 mb-1 preview-image"
                                id="picture_112">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_113.jpg') }}" alt="picture 113" class="w-100 mb-1 preview-image"
                                id="picture_113">
                            <img src="{{ asset('picture_114.jpg') }}" alt="picture 114" class="w-100 mb-1 preview-image"
                                id="picture_114">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_115.jpg') }}" alt="picture 115" class="w-100 mb-1 preview-image"
                                id="picture_115">
                            <img src="{{ asset('picture_116.jpg') }}" alt="picture 116" class="w-100 mb-1 preview-image"
                                id="picture_116">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_117.jpg') }}" alt="picture 117" class="w-100 mb-1 preview-image"
                                id="picture_117">
                            <img src="{{ asset('picture_118.jpg') }}" alt="picture 118" class="w-100 mb-1 preview-image"
                                id="picture_118">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_119.jpg') }}" alt="picture 119" class="w-100 mb-1 preview-image"
                                id="picture_119">
                            <img src="{{ asset('picture_120.jpg') }}" alt="picture 120" class="w-100 mb-1 preview-image"
                                id="picture_120">
                        </div>
                    </div>
