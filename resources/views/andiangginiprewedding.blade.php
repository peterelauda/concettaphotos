    ...
    <section id="novitafamily">
        <div class="container-fluid py-5">
            <div class="px-4 py-3 text-center">
                <h1 class="display-7 custom-text-3 mb-2 lang-content lang-en">Andi & Anggini Prewedding Album</h1>
                <h1 class="display-7 custom-text-3 mb-2 lang-content lang-id d-none">Album Prewedding Andi & Anggini
                </h1>
