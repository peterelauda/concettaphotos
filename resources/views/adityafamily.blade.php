...
<head>
    ...
    <meta property="og:image" content="{{ url('adityafamily_mobile.jpg') }}" />
    ...
    <meta name="twitter:image" content="{{ url('adityafamily_mobile.jpg') }}" />
...
<body>
    ...
    <section id="picture" class="position-relative">
        <div class="position-relative w-100 d-none d-lg-flex" style="height: 636px;">
            <img src="{{ asset('adityafamily.jpg') }}" alt="Novita Family picture"
        ...
        <div class="position-relative w-100 d-flex d-lg-none" style="height: 636px;">
            <img src="{{ asset('adityafamily_mobile.jpg') }}" alt="Novita Family picture"
                class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-n1">
        </div>
    </section>
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            ...
                            <img src="{{ asset('picture_21.jpg') }}" alt="picture 21" class="w-100 mb-1 preview-image"
                                id="picture_21">
                            <img src="{{ asset('picture_22.jpg') }}" alt="picture 22" class="w-100 mb-1 preview-image"
                                id="picture_22">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_23.jpg') }}" alt="picture 23" class="w-100 mb-1 preview-image"
                                id="picture_23">
                            <img src="{{ asset('picture_24.jpg') }}" alt="picture 24" class="w-100 mb-1 preview-image"
                                id="picture_24">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_25.jpg') }}" alt="picture 25" class="w-100 mb-1 preview-image"
                                id="picture_25">
                            <img src="{{ asset('picture_26.jpg') }}" alt="picture 26" class="w-100 mb-1 preview-image"
                                id="picture_26">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_27.jpg') }}" alt="picture 27" class="w-100 mb-1 preview-image"
                                id="picture_27">
                            <img src="{{ asset('picture_28.jpg') }}" alt="picture 28" class="w-100 mb-1 preview-image"
                                id="picture_28">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_29.jpg') }}" alt="picture 29" class="w-100 mb-1 preview-image"
                                id="picture_29">
                            <img src="{{ asset('picture_30.jpg') }}" alt="picture 30" class="w-100 mb-1 preview-image"
                                id="picture_30">
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3 hidden-gallery d-none">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_31.jpg') }}" alt="picture 31" class="w-100 mb-1 preview-image"
                                id="picture_31">
                            <img src="{{ asset('picture_32.jpg') }}" alt="picture 32" class="w-100 mb-1 preview-image"
                                id="picture_32">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_33.jpg') }}" alt="picture 33" class="w-100 mb-1 preview-image"
                                id="picture_33">
                            <img src="{{ asset('picture_34.jpg') }}" alt="picture 34" class="w-100 mb-1 preview-image"
                                id="picture_34">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_35.jpg') }}" alt="picture 35" class="w-100 mb-1 preview-image"
                                id="picture_35">
                            <img src="{{ asset('picture_36.jpg') }}" alt="picture 36" class="w-100 mb-1 preview-image"
                                id="picture_36">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_37.jpg') }}" alt="picture 37" class="w-100 mb-1 preview-image"
                                id="picture_37">
                            <img src="{{ asset('picture_38.jpg') }}" alt="picture 38" class="w-100 mb-1 preview-image"
                                id="picture_38">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_39.jpg') }}" alt="picture 39" class="w-100 mb-1 preview-image"
                                id="picture_39">
                            <img src="{{ asset('picture_40.jpg') }}" alt="picture 40" class="w-100 mb-1 preview-image"
                                id="picture_40">
                        </div>
                    </div>
