...
<head>
    ...
    <title>Concetta Photos - Linda Family</title>
    ...
    <meta property="og:image" content="{{ url('lindafamily_mobile.jpg') }}" />
    ...
    <meta name="twitter:image" content="{{ url('lindafamily_mobile.jpg') }}" />
...
<body>
    ...
    <section id="picture" class="position-relative">
        <div class="position-relative w-100 d-none d-lg-flex" style="height: 636px;">
            <img src="{{ asset('lindafamily.jpg') }}" alt="Linda Family picture"
        ...
        <div class="position-relative w-100 d-flex d-lg-none" style="height: 636px;">
            <img src="{{ asset('lindafamily_mobile.jpg') }}" alt="Linda Family picture"
                class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-n1">
        </div>
    </section>

    <section id="lindafamily">
        <div class="container-fluid py-5">
            <div class="px-4 py-3 text-center">
                <h1 class="display-5 aesthetic-text-1 mb-2 lang-content lang-en">Linda's Family Album</h1>
                <h1 class="display-5 aesthetic-text-1 mb-2 lang-content lang-id d-none">Album Keluarga Linda</h1>
                <div class="col-12 col-sm-12 col-md-9 col-lg-6 col-xl-3 mx-auto custom-border-divider mb-2"></div>
                <h1 class="display-7 aesthetic-text-3 mb-5 lang-content lang-en">At Petitenget Beach</h1>
                <h1 class="display-7 aesthetic-text-3 mb-5 lang-content lang-id d-none">di Pantai Petitenget</h1>
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            ...
                            <img src="{{ asset('picture_61.jpg') }}" alt="picture 61" class="w-100 mb-1 preview-image"
                                id="picture_61">
                            <img src="{{ asset('picture_62.jpg') }}" alt="picture 62" class="w-100 mb-1 preview-image"
                                id="picture_62">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_63.jpg') }}" alt="picture 63" class="w-100 mb-1 preview-image"
                                id="picture_63">
                            <img src="{{ asset('picture_64.jpg') }}" alt="picture 64" class="w-100 mb-1 preview-image"
                                id="picture_64">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_65.jpg') }}" alt="picture 65" class="w-100 mb-1 preview-image"
                                id="picture_65">
                            <img src="{{ asset('picture_66.jpg') }}" alt="picture 66" class="w-100 mb-1 preview-image"
                                id="picture_66">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_67.jpg') }}" alt="picture 67" class="w-100 mb-1 preview-image"
                                id="picture_67">
                            <img src="{{ asset('picture_68.jpg') }}" alt="picture 68" class="w-100 mb-1 preview-image"
                                id="picture_68">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_69.jpg') }}" alt="picture 69" class="w-100 mb-1 preview-image"
                                id="picture_69">
                            <img src="{{ asset('picture_70.jpg') }}" alt="picture 70" class="w-100 mb-1 preview-image"
                                id="picture_70">
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3 hidden-gallery d-none">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_71.jpg') }}" alt="picture 71" class="w-100 mb-1 preview-image"
                                id="picture_71">
                            <img src="{{ asset('picture_72.jpg') }}" alt="picture 72" class="w-100 mb-1 preview-image"
                                id="picture_72">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_73.jpg') }}" alt="picture 73" class="w-100 mb-1 preview-image"
                                id="picture_73">
                            <img src="{{ asset('picture_74.jpg') }}" alt="picture 74" class="w-100 mb-1 preview-image"
                                id="picture_74">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_75.jpg') }}" alt="picture 75" class="w-100 mb-1 preview-image"
                                id="picture_75">
                            <img src="{{ asset('picture_76.jpg') }}" alt="picture 76" class="w-100 mb-1 preview-image"
                                id="picture_76">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_77.jpg') }}" alt="picture 77" class="w-100 mb-1 preview-image"
                                id="picture_77">
                            <img src="{{ asset('picture_78.jpg') }}" alt="picture 78" class="w-100 mb-1 preview-image"
                                id="picture_78">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_79.jpg') }}" alt="picture 79" class="w-100 mb-1 preview-image"
                                id="picture_79">
                            <img src="{{ asset('picture_80.jpg') }}" alt="picture 80" class="w-100 mb-1 preview-image"
                                id="picture_80">
                        </div>
                    </div>
