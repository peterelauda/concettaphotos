...
<body>
    <section id="header">
        <header id="mainHeader"
            ...
            <div class="d-none d-xl-block" style="width: 292.89px;"></div>
            ...
            <div class="d-none d-xl-flex align-items-center gap-4 mx-auto">
                <li class="nav-item dropdown list-unstyled mx-3">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="#">BRAND PHOTOSHOOT</a></li>
                ...
                <li class="nav-item dropdown list-unstyled mx-3">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#">CONCETTA PHOTOS</a></li>
                        <li><a class="dropdown-item" href="#">PHOTOSHOOT PACKAGE</a></li>
                    </ul>
                </li>

                <li class="nav-item dropdown list-unstyled mx-3">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">MEET CONCETTA</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#">CONCETTA MAN</a></li>
                        <li><a class="dropdown-item" href="#">CONCETTA GEAR</a></li>
                    </ul>
                </li>

                <li class="nav-item dropdown list-unstyled mx-3">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('logo_cp1.png') }}" alt="Logo" width="70px">
                    </a>
                </li>

                <li class="nav-item dropdown list-unstyled mx-3">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">CONCETALK</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#">RECOMMENDED BEACH LOCATION</a></li>
                        <li><a class="dropdown-item" href="#">RECOMMENDED REGION LOCATION</a></li>
                    </ul>
                </li>
            ...
            <div class="d-none d-xl-block text-end">
                @if (Route::has('login'))
                    <nav>
                        @auth
                            <a href="{{ url('/dashboard') }}" class="btn btn-primary me-2">COME IN</a>
                        @else
                            <a href="{{ route('login') }}" class="btn btn-outline-primary mx-2 my-2">YOUR INQUIRIES</a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="btn btn-primary mx-2 my-2">BE MEMBER</a>
                            @endif
                        @endauth
                    </nav>
                @endif
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
            <div class="offcanvas-header position-relative justify-content-center">
                <h5 class="offcanvas-title m-0">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('logo_cp1.png') }}" alt="Logo" width="50px">
                    </a>
                </h5>
            ...
            <div class="offcanvas-body">
                <div class="accordion" id="accordionMenu">
                    @php
                        $menus = [
                            ...
                            'CONCETALK' => [
                                'RECOMMENDED BEACH LOCATION' => '#',
                                'RECOMMENDED REGION LOCATION' => '#',
                            ],
                        ];
                    @endphp
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading-{{ Str::slug($title) }}">
                                <button class="accordion-button collapsed btn-primary" type="button"
                                    data-bs-toggle="collapse" data-bs-target="#collapse-{{ Str::slug($title) }}"
                                    aria-expanded="false" aria-controls="collapse-{{ Str::slug($title) }}">
                                    {{ $title }}
                                </button>
                            </h2>
                            <div id="collapse-{{ Str::slug($title) }}" class="accordion-collapse collapse"
                                aria-labelledby="heading-{{ Str::slug($title) }}" data-bs-parent="#accordionMenu">
                                <div class="accordion-body">
                                    <ul class="list-unstyled mb-0">
                                        @foreach ($items as $label => $url)
                                            <li><a class="nav-link" href="{{ url($url) }}">{{ $label }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="mt-4">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="btn btn-primary w-100 mb-2">COME IN</a>
                        @else
                            <a href="{{ route('login') }}" class="btn btn-outline-primary w-100 mb-2">YOUR INQUIRIES</a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="btn btn-primary w-100">BE MEMBER</a>
                            @endif
                        @endauth
                    @endif
                </div>
        ...
        <main class="container">
            <div
                ...
                <div class="col-lg-6 px-0">
                    <h2 class="display-7 custom-text">Our Recent Jobs</h2>
    ...
    <section id="service">
        <main class="container">
            <div
                class="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body d-flex justify-content-center align-items-center text-center">
                <div class="col-lg-6 px-0">
                    <h2 class="display-7 custom-text">Our Services</h2>
                    <div class="col-10 col-md-8 col-lg-6 mx-auto pt-3 custom-border-divider"></div>
                </div>
            </div>
                    ...
                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 g-4">
                        <div class="col">
                            <div class="card shadow-sm">
                                <a href="/holiday" class="image-hover-wrapper text-decoration-none">
                                    <div class="image-hover-container">
                                        <img src="{{ asset('picture8.jpg') }}" alt="Holiday Picture"
                                            class="card-img-top image-hover-img">
                                        <div class="image-hover-overlay">
                                            <h1 class="custom-text-2">Holiday</h1>
                                            <h4 class="custom-text-2">See more holiday albums</h4>
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    <h3 class="card-text custom-text-0">Holiday
                                    </h3>
                                    <p class="card-text custom-text-0">Capture your precious moments while traveling or
                                        enjoying your
                                        holiday. Whether it's a beach trip, a mountain escape, or exploring a new city —
                                        make every memory last.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group"> <a href="/holiday" class="btn btn-sm btn-primary">View
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a href="/couple" class="image-hover-wrapper text-decoration-none">
                                    <div class="image-hover-container">
                                        <img src="{{ asset('picture1.jpg') }}" alt="Couple Picture"
                                            class="card-img-top image-hover-img">
                                        <div class="image-hover-overlay">
                                            <h1 class="custom-text-2">Couple</h1>
                                            <h4 class="custom-text-2">See more couple albums</h4>
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    ...
                                    <p class="card-text custom-text-0">Celebrate love through intimate and timeless
                                        photographs. Perfect for anniversaries, special dates, or just a moment to
                                        remember together.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group"> <a href="/couple" class="btn btn-sm btn-primary">View
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                <a href="/family" class="image-hover-wrapper text-decoration-none">
                                    <div class="image-hover-container">
                                        <img src="{{ asset('picture2.jpg') }}" alt="Family Picture"
                                            class="card-img-top image-hover-img">
                                        <div class="image-hover-overlay">
                                            <h1 class="custom-text-2">Family</h1>
                                            <h4 class="custom-text-2">See more family albums</h4>
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    ...
                                    <p class="card-text custom-text-0">Cherish your family's unique bond with warm,
                                        candid, and heartwarming portraits. Great for yearly keepsakes or special
                                        occasions.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group"> <a href="/family" class="btn btn-sm btn-primary">View
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                <a href="/maternity" class="image-hover-wrapper text-decoration-none">
                                    <div class="image-hover-container">
                                        <img src="{{ asset('picture3.jpg') }}" alt="Maternity Picture"
                                            class="card-img-top image-hover-img">
                                        <div class="image-hover-overlay">
                                            <h1 class="custom-text-2">Maternity</h1>
                                            <h4 class="custom-text-2">See more maternity albums</h4>
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    <h3 class="card-text custom-text-0">Maternity
                                    </h3>
                                    <p class="card-text custom-text-0">Highlight the beauty of motherhood with elegant
                                        maternity portraits. A gentle and emotional way to remember the journey to
                                        parenthood.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group"> <a href="/maternity" class="btn btn-sm btn-primary">View
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <a href="/prewedding" class="image-hover-wrapper text-decoration-none">
                                    <div class="image-hover-container">
                                        <img src="{{ asset('picture4.jpg') }}" alt="Prewedding Picture"
                                            class="card-img-top image-hover-img">
                                        <div class="image-hover-overlay">
                                            <h1 class="custom-text-2">Prewedding</h1>
                                            <h4 class="custom-text-2">See more prewedding albums</h4>
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    ...
                                    <p class="card-text custom-text-0">Tell your love story before the big day. Artistic
                                        and personalized sessions that reflect your chemistry and excitement.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                ...
                                <a href="/wedding" class="image-hover-wrapper text-decoration-none">
                                    <div class="image-hover-container">
                                        <img src="{{ asset('picture5.jpg') }}" alt="Wedding Picture"
                                            class="card-img-top image-hover-img">
                                        <div class="image-hover-overlay">
                                            <h1 class="custom-text-2">Wedding</h1>
                                            <h4 class="custom-text-2">See more Wedding albums</h4>
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    ...
                                    <p class="card-text custom-text-0">Capture the joy, emotion, and unforgettable
                                        details of your wedding day. From intimate moments to grand celebrations, every
                                        photo tells a story.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group"> <a href="/wedding" class="btn btn-sm btn-primary">View
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                <a href="/brand" class="image-hover-wrapper text-decoration-none">
                                    <div class="image-hover-container">
                                        <img src="{{ asset('picture6.jpg') }}" alt="Brand Photoshoot Picture"
                                            class="card-img-top image-hover-img">
                                        <div class="image-hover-overlay">
                                            <h1 class="custom-text-2">Brand Photoshoot</h1>
                                            <h4 class="custom-text-2">See more brand photoshoot albums</h4>
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    ...
                                    <p class="card-text custom-text-0">Professional images that bring your brand to
                                        life. Ideal for entrepreneurs, businesses, and creatives seeking impactful
                                        visual content.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group"> <a href="/brand" class="btn btn-sm btn-primary">View
                                                More</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                <a href="/event" class="image-hover-wrapper text-decoration-none">
                                    <div class="image-hover-container">
                                        <img src="{{ asset('picture7.jpg') }}" alt="Event Picture"
                                            class="card-img-top image-hover-img">
                                        <div class="image-hover-overlay">
                                            <h1 class="custom-text-2">Event</h1>
                                            <h4 class="custom-text-2">See more event albums</h4>
                                        </div>
                                    </div>
                                </a>
                                <div class="card-body">
                                    <h3 class="card-text custom-text-0">Event
                                    </h3>
                                    <p class="card-text custom-text-0">Document special moments from your events —
                                        corporate gatherings, birthdays, launches, and more. Focused, vibrant, and
                                        story-driven.
                                    </p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="btn-group"> <a href="/event" class="btn btn-sm btn-primary">View
                                                More</a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container-fluid">
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4">
                <div class="col-md-4 d-flex align-items-center">
                    ...
                    <span class="mb-3 mb-md-0 text-body-secondary">© 2025 Concetta Photos</span>
                </div>

                <ul class="nav col-md-4 justify-content-end list-unstyled d-flex mx-5">
                    <li class="ms-3"><a class="text-body-secondary" href="https://www.instagram.com/concettaphotos/"
                            aria-label="Instagram"><img src="{{ asset('instagram_logo.png') }}"
                                class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
                                width="28" height="28" alt="Logo Instagram" /></a></li>
                    <li class="ms-3"><a class="text-body-secondary"
                            href="https://www.tiktok.com/@concettaphotos?is_from_webapp=1&sender_device=pc"
                            aria-label="Tiktok"><img src="{{ asset('tiktok_logo.png') }}"
                                class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
                                width="28" height="28" alt="Logo Tiktok" /></a></li>
                    <li class="ms-3"><a class="text-body-secondary" href="https://www.threads.com/@concettaphotos"
                            aria-label="Tiktok"><img src="{{ asset('thread_logo.png') }}"
                                class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
                                width="28" height="28" alt="Logo Tiktok" /></a></li>
                    <li class="ms-3"><a class="text-body-secondary" href="https://x.com/ConcettaPhotos_"
                            aria-label="Tiktok"><img src="{{ asset('twitter_logo.png') }}"
                                class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
                                width="28" height="28" alt="Logo Tiktok" /></a></li>
                </ul>
            </footer>
