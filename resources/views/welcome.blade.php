    ...
    <section id="header">
        <header id="mainHeader"
            ...
            <div class="d-none d-xl-flex align-items-center gap-4 mx-auto">
                ...
                <li class="nav-item dropdown list-unstyled mx-3">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">MEET TEAM</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#">Our Story</a></li>
                        <li><a class="dropdown-item" href="#">Our Philosophy</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown list-unstyled mx-3">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">PHOTO GUIDES</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#">Lighting</a></li>
                        <li><a class="dropdown-item" href="#">Composition</a></li>
                        <li><a class="dropdown-item" href="#">Editing Tricks</a></li>
                        <li><a class="dropdown-item" href="#">Gear Guides</a></li>
                    </ul>
                </li>
                    ...
                    @php
                        $menus = [
                            ...
                            'PHOTO TIPS' => [
                                ...
                                'Composition' => '/tips/composition',
                                'Editing Tricks' => '/tips/editing-tricks',
                                'Gear Guides' => '/tips/gear-guides',
                            ],
                            'TESTIMONIALS' => [
                                'Client Stories' => '/testimonials/clients',
                                'Video Testimonials' => '/testimonials/videos',
                            ],
                            'INQUIRIES' => [
                                'General Inquiry' => '/inquiries/general',
                                'Booking' => '/inquiries/booking',
                                'Pricing' => '/inquiries/pricing',
                                'Partnerships' => '/inquiries/partnerships',
                            ],
                        ];
                    @endphp
        ...
        <div class="container-fluid">
            <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4">
                ...
                <ul class="nav col-md-4 justify-content-end list-unstyled d-flex mx-5">
                    <li class="ms-3"><a class="text-body-secondary" href="https://www.instagram.com/concettaphotos/" aria-label="Instagram"><img
                                src="{{ asset('instagram_logo.png') }}"
                                class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
                                width="28" height="28" alt="Logo Instagram" /></a></li>
                    <li class="ms-3"><a class="text-body-secondary" href="https://www.tiktok.com/@concettaphotos?is_from_webapp=1&sender_device=pc" aria-label="Tiktok"><img
                                src="{{ asset('tiktok_logo.png') }}"
                                class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto"
