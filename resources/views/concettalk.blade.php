...
<head>
    ...
    <style>
        ...
        .img-overlay {
            ...
            width: 100%;
            height: 100%;
            background-color: rgba(87, 143, 202, 0.77);
            display: flex;
...
<body>
    ...
    <section id="vlog">
        <div class="px-5 py-5 text-center d-flex flex-column align-items-center"> <svg
        ...
        <main class="container">
            <div
                ...
                <div class="col-lg-6 px-0">
                    ...
                    <h5 class="display-10 custom-text lang-content lang-en">Are we feeling familiar with each other now?
                    </h5>
                    <h5 class="display-10 custom-text lang-content lang-id d-none">Sekarang kita sudah cukup saling
                        mengenal kan?</h5>
