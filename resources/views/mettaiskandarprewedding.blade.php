...
<head>
    ...
    <title>Concetta Photos - Metta Iskandar Prewedding</title>
    ...
    <meta property="og:image" content="{{ url('mettaiskandar_mobile.jpg') }}" />
    ...
    <meta name="twitter:image" content="{{ url('mettaiskandar_mobile.jpg') }}" />
...
<body>
    ...
    <section id="picture" class="position-relative">
        <div class="position-relative w-100 d-none d-xl-flex" style="height: 636px;">
            <img src="{{ asset('mettaiskandar.jpg') }}" alt="Novita Family picture"
        ...
        <div class="position-relative w-100 d-flex d-xl-none" style="height: 636px;">
            <img src="{{ asset('mettaiskandar_mobile.jpg') }}" alt="Novita Family picture"
                class="position-absolute top-0 start-0 w-100 h-100 object-fit-cover z-n1">
        </div>
    </section>
    ...
    <section id="novitafamily">
        <div class="container-fluid py-5">
            <div class="px-4 py-3 text-center">
                <h1 class="display-7 aesthetic-text-1 mb-2 lang-content lang-en">Metta & Iskandar Prewedding Album</h1>
                <h1 class="display-7 aesthetic-text-1 mb-2 lang-content lang-id d-none">Album Prewedding Metta &
                    Iskandar
                </h1>
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            ...
                            <img src="{{ asset('picture_141.jpg') }}" alt="picture 141" class="w-100 mb-1 preview-image"
                                id="picture_141">
                            <img src="{{ asset('picture_142.jpg') }}" alt="picture 142" class="w-100 mb-1 preview-image"
                                id="picture_142">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_143.jpg') }}" alt="picture 143" class="w-100 mb-1 preview-image"
                                id="picture_143">
                            <img src="{{ asset('picture_144.jpg') }}" alt="picture 144" class="w-100 mb-1 preview-image"
                                id="picture_144">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_145.jpg') }}" alt="picture 145" class="w-100 mb-1 preview-image"
                                id="picture_145">
                            <img src="{{ asset('picture_146.jpg') }}" alt="picture 146" class="w-100 mb-1 preview-image"
                                id="picture_146">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_147.jpg') }}" alt="picture 147" class="w-100 mb-1 preview-image"
                                id="picture_147">
                            <img src="{{ asset('picture_148.jpg') }}" alt="picture 148" class="w-100 mb-1 preview-image"
                                id="picture_148">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_149.jpg') }}" alt="picture 149" class="w-100 mb-1 preview-image"
                                id="picture_149">
                            <img src="{{ asset('picture_150.jpg') }}" alt="picture 150" class="w-100 mb-1 preview-image"
                                id="picture_150">
                        </div>
                    </div>
                    ...
                    <div class="d-flex flex-wrap justify-content-center gap-1 px-3 hidden-gallery d-none">
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_151.jpg') }}" alt="picture 151" class="w-100 mb-1 preview-image"
                                id="picture_151">
                            <img src="{{ asset('picture_152.jpg') }}" alt="picture 152" class="w-100 mb-1 preview-image"
                                id="picture_152">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_153.jpg') }}" alt="picture 153" class="w-100 mb-1 preview-image"
                                id="picture_153">
                            <img src="{{ asset('picture_154.jpg') }}" alt="picture 154" class="w-100 mb-1 preview-image"
                                id="picture_154">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_155.jpg') }}" alt="picture 155" class="w-100 mb-1 preview-image"
                                id="picture_155">
                            <img src="{{ asset('picture_156.jpg') }}" alt="picture 156" class="w-100 mb-1 preview-image"
                                id="picture_156">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_157.jpg') }}" alt="picture 157" class="w-100 mb-1 preview-image"
                                id="picture_157">
                            <img src="{{ asset('picture_158.jpg') }}" alt="picture 158" class="w-100 mb-1 preview-image"
                                id="picture_158">
                        </div>
                        <div class="d-flex flex-column flex-grow-1 flex-shrink-0 gallery-column"
                            style="flex-basis: 180px;">
                            <img src="{{ asset('picture_159.jpg') }}" alt="picture 159" class="w-100 mb-1 preview-image"
                                id="picture_159">
                            <img src="{{ asset('picture_160.jpg') }}" alt="picture 160" class="w-100 mb-1 preview-image"
                                id="picture_160">
                        </div>
                    </div>
