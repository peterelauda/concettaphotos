    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <select id="domicile" name="domicile"
                ...
                @foreach (['Badung', 'Bangli', 'Buleleng', 'Gianyar', 'Jembrana', 'Karangasem', 'Klungkung', 'Tabanan', 'Denpasar'] as $city)
                    <option value="{{ $city }}" {{ old('domicile', $user->domicile) === $city ? 'selected' : '' }}>
                        {{ $city }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="mt-3">
            <x-input-label for="country" :value="__('Country')" class="mb-2" />
